try {
    window.samAdminLoad = function() {
            console.log("执行移植的js代码");
            /*****
             * CONFIGURATION
             */
            function loadJS(e, t) {
            ...
            function loadPage(e) {
                ...
                $.ajax({
                    ...
                    dataType: "html",
                    cache: !0,
                    beforeSend: function() { t.css("opacity", .5) },
                    success: function(e) {
                        Pace.restart();
                        $("html, body").animate({ scrollTop: 0 }, 0);
                        t.css({ opacity: 0 }).html(e).delay(250).animate({ opacity: 1 }, 500)
                    },
                    error: function(e, n, r) { t.html('<h4 style="margin-top:90px;"><i class="fa fa-warning"></i> Error 404! Page not found.</h4>') },
                    async: !1
                })
            }
            ...
            function activeCharts() {
                ...
                $(".chart-stat").length && (retina() ? $(".chart-stat > .chart").each(function() {
                    ...
                    $(this).sparkline("html", { width: "180%", height: 80, lineColor: e, fillColor: !1, spotColor: !1, maxSpotColor: !1, minSpotColor: !1, spotRadius: 2, lineWidth: 2 });
                    if (jQuery.browser.mozilla)
                        if (!navigator.userAgent.match(/Trident\/7\./)) {
                    ...
                    var e = $(this).css("color");
                    $(this).sparkline("html", { width: "90%", height: 40, lineColor: e, fillColor: !1, spotColor: !1, maxSpotColor: !1, minSpotColor: !1, spotRadius: 2, lineWidth: 2 })
                }))
            }
            ...
            function discussionWidget() { $(".discussions").find(".delete").click(function() { $(this).parent().fadeTo("slow", 0, function() { $(this).slideUp("slow", function() { $(this).remove() }) }) }) }
            ...
            $(document).ready(function(e) {
                ...
                //     console.log(e(this).parent().find("ul"));
                ...
                //         e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("slow", function() { e(this).parent().removeClass("opened") })
                //     } else e(this).parent().parent().parent().hasClass("opened") || e(".nav a").not(this).parent().find("ul").slideUp("slow", function() { e(this).parent().removeClass("opened") })
                // });
                // e("#main-menu-toggle").click(function() { e("body").hasClass("sidebar-hide") ? e("body").removeClass("sidebar-hide") : e("body").addClass("sidebar-hide") });
